...
4. Load Docs Metadata (NO content "DocContent")
   ...
   -Z2 (Master) :Z1 + Union SELECT ...  FROM [VisualERP.Master][dbo].[frwAI_Documentation] 
   -Z3 (Zone)  : Z1 + Z2 + Union SELECT ...  FROM [frwAI_Documentation] where
5. Load Schema Cache (IsStartupCache =1) 
   ...
   -Z2 (Master) :Z1 + Union SELECT ...  FROM [VisualERP.Master][dbo].[frwAI_SchemaCache] Where ...
   -Z3 (Zone)  : Z1 + Z2 + Union SELECT ...  FROM [frwAI_SchemaCache] Where ...
